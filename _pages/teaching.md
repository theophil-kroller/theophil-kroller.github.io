...
One of my core beliefs is that it is our job as teachers to prepare students to be ready and able to solve the problems of their time. I want to teach in such a way that students learn transferable skills, grow as a person and are able to contribute amd excell in an internationally competitive environment. In order to achieve this, I believe it is important that students move behind understanding concepts. Students should learn concepts and methods by being able to apply them to (ideally) not yet solved problems, because this is the way that will train them to be ready for entering the workforce prepared. Knowledge becomes meaningful when students can apply it to real situations, uncertain decisions, and problems that do not yet have a finished answer.

I therefore try my best to design learning situations in such a way that they combine some form of structure and also openness. Students need clear explanations, useful frameworks, good examples and best practice stories. At the same time, they need opportunities to ask questions (without being judged), test their ideas, compare their perspectives to others, create visible outputs, receive feedback (peer feedback and lecturer feedback), and reflect on what they have learned.

In all of this, curiosity is the central element that guides this process. I therefore value teaching situations in which questions open up the learning space: i.e What do we observe here? Why might this be the case? Why not? What changes if we look at the problem from another perspective? In my own teaching, I try to keep this spirit of inquiry, dialogue, and shared sense-making alive, even if it sometimes puts me in a situation where I don't have all the answers.
...
Feedback is another element of my teaching. In all of my teaching I have relied heaviliy on feeedback: teacher feedback, peer feedback, discussions, presentation feedback, and structured assessment formats to support learning. Feedback should not only evaluate performance; it should help students see what already works, where their thinking can become sharper, and how they can take the next steps. I try to maintain a positive and encouraging spirit when giving feedback.
...
<p>In 2008/2009 I was asked to do private language teaching. I studied Japanese at that time, and my Japanese teacher had asked me if I was willing to teach German as a foreign language to the wife of a Japanese diplomat and the wife of a Japanese professor. I accepted and again found myself in a similar format to what had proven successfull earlier: I gave them writing assignments, and that again guided me in where to work with them. We did role plays, conversation exercises, grammar exercises and vocabulary building exercises. </p>
...
In the Entrepreneurship course, I facilitate a Design Thinking session based on the Stanford d.school “Lunch Experience” materials. Here I want to make a disclaimer: I did not develop this format myself, and I also did not introduce it to the course. This was done by a former colleague and during my very first iteration of the course I participated in this activity together with the other students of the course. I do remain commited to teaching it, becasue I myself experienced a lot of fun dooing it and because it allows students to experience a complete innovation process in a short and accessible way.

Students move through the process of understanding user needs, interviewing, ideating, prototyping, testing, and reflecting. This makes Design Thinking more tangible than a purely conceptual explanation. The session is often lively witrh activating and reflective music playing in the background, a countdown timer running and me in my facilitor role giving instructions and encouraging students. It helps students experience how customer orientation, rapid prototyping, and feedback can support the development of entrepreneurial ideas. I think this activity is a big learning experience for how to approach product innovation that they will not forget so easily.
...
The common pattern that is visible across the above mentioned examples: I try to move students from listening to concepts towards working with them. Of course students still need an introduction first so that they grasp methods and frameworks through example. Nut I try to combine these inputs with activities that require students to apply, compare, visualize, discuss, evaluate, or create something new.
...
When I first started teaching, I could not fully grasp teaching competence as a broad professional competence yet. In China, actually much of my teaching developed through experimentation. I had limited ressources available but I was young, confident, and willing to try things out. One of my first insights was that teaching becomes more meaningful when students are asked actively work with knowledge.

One example that resulted from this period was the discussion format on world affairs. Instead of asking students to give traditional presentations on freely chosen topics, as other lecturers had done in the past, I asked them to prepare a short opening statement on a current topic in world politics or current news and then moderate a discussion with their classmates. Together with my mother, who was an English teacher, I also developed my very first grading rubric for this format. The assessment criteria were made transparent to the students, and at the end of the activity they had to submit a short reflection summarizing the discussion. This was one of my first experiences of designing an assessment format around the actual communicative competence I wanted students to develop. I realized that in order to become fluent in speaking you would need to practice this skill by developing the ability to lead a discussion, responding to others, moderating interaction, and reflecting afterwards. The activity was well received by the students, because it was novel and it challenged them. It also boosted their confidence.

At the UAS Technikum Wien I learned from colleagues, observed what I identified as good practice, and gradually developed my own approaches to laboratory teaching. I also made my first experiences with Moodle-based course organization, exam assessment, and developing teaching materials. One important development was the introduction of laboratory entrance tests. I had observed that some students came to the laboratory insufficiently prepared, which affected both safety and the quality of learning. I therefore introduced a preparatory assessment: students had to engage with the theoretical background before entering the laboratory, and if they did not pass the entrance check, they had to prepare again. In retrospect, this was already close to a flipped-classroom logic, although I did not use that terminology at the time. The effect was clearly visible: students came better prepared, and the laboratory sessions became more focused and productive.

Another important step at UAS Technikum Wien was the development of a structured rubric for laboratory reports. Before that, the quality and structure of reports varied considerably. I introduced a scheme along the IMRAD structure and developed assessment criteria that made expectations clearer and feedback more consistent. Compared to the rubrices I use now this was at a rather basic level. However the rubric later also proved useful for other lecturers.
...
An important realization that I had in my current teaching is that structure creates a calm atmosphere. Structure does not mean controlling every moment of a session. It creates orientation and security, both for students and for myself. A clear structure makes it easier to open spaces for discussion, experimentation, group work, and student contributions. Students need input, frameworks, and examples, but input alone is not enough. Learning becomes stronger when students actively process ideas, apply concepts, create visible outputs, discuss alternatives, take roles, challenge each other, or reflect on their own work.

This is why my focuse has shifted more towards creating learning experiences. A good learning experience for me is a situation in which students do something with content. This could be moderating a discussion, classifying leadership behavior, drawing an organizational structure, developing a persona or organizata, estimating a market, prototyping an idea, giving feedback from a stakeholder perspective, or challenging a business model. These activities create moments that remain more memorable than pure explanation, because students connect concepts with action, interaction, and their own thinking.

Concerning my teaching style, I can say that it is an ongoing process. Slides still remain an important support structure for me, especially for orientation and timing. I also find that they give the class structure. However, I would like to move further toward more "open" teaching sequences, more work with blackboards, whiteboards, flipcharts and more movement in the room. I want to become less dependent on the lectern and the screen, and more able to generate structures together with students in the moment. This includes asking more questions, collecting student ideas visually (i.e. through index cards), building on their contributions, and using the board or flipchart as a shared thinking space.
