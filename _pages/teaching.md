...
These two quotes come from very different intellectual traditions, yet they meet in a shared understanding of learning. Confucius reminds us that learning becomes meaningful through repeated practice, reflection, and the joy of returning to what one has learned. Aristotle points in a similar direction from within another philosophical world: we learn what we are meant to do by doing it. In both traditions, learning is not understood as the passive possession of knowledge, but as a formative practice through which people develop judgement, capability, and orientation.

This understanding of learning also speaks to the changing role of the university today. In the medieval university, the lecture had a very specific function: it made knowledge accessible. A learned person read, explained, interpreted, and transmitted texts that students could not easily access on their own. In this historical context, the lecture was not merely a teaching format; it was a gateway to knowledge.

Today, we live in a very different world. Knowledge is no longer scarce in the same way. Students can access explanations, tutorials, online courses, Wikipedia, MOOCs, YouTube lectures, and generative AI within seconds. This is a remarkable development, but it also raises a demanding question: if knowledge has become widely available, what makes university education valuable?

For me, the answer is that university teaching must do something that access to information alone cannot do. It must help students transform information into understanding, understanding into judgement, and judgement into responsible action. The university remains meaningful when it becomes a structured space for intellectual, practical, and personal development: a place where students train their minds, test ideas, encounter different perspectives, receive feedback, grow as persons, and prepare to work on the problems of their time.

This is also connected to the realities students will face after graduation. In a global and internationally competitive job market, it is not enough to know concepts or reproduce models. Students need transferable skills, confidence in their own thinking, judgement under uncertainty, initiative, communication skills, and practical readiness. They need to be able to engage with open questions, incomplete information, different stakeholder perspectives, and complex problems that do not come with finished answers.

This is the point of departure for my teaching philosophy: I understand teaching as the design of learning spaces. Such spaces need structure, but they also need openness. They need clear concepts, useful frameworks, good examples, and tasks that make sense. At the same time, they need room for inquiry, experimentation, dialogue, mistakes, feedback, reflection, and the gradual development of independent judgement. Good teaching, in this sense, is not only about explaining content clearly. It is about creating situations in which students can connect knowledge with action.

{% include figure.liquid loading="eager" path="assets/img/educational_cycle_and_framework_diagram.png" title="Teaching as the Design of Learning Spaces" class="img-fluid rounded z-depth-1 mb-2" %}
<p class="figure-note">My teaching philosophy in one view: learning spaces combine structure and openness so that knowledge can become judgement, capability, and responsible action.</p>

The figure summarizes this understanding of teaching as a learning cycle. Students first need concepts and frameworks that help them see, structure, and interpret a problem. But these concepts should not remain abstract. They should be brought into contact with real-world questions, ideally with problems that are open, uncertain, or not yet fully solved. Students then apply ideas, experiment with possible approaches, experience moments of productive struggle, and learn from the tension between theory and practice. Feedback and reflection help them understand where they stand, what they have learned, and what their next step could be. Over time, this process supports the development of independent judgement and growing capability.

Curiosity is an important driver of this process. Some of the most valuable teaching moments begin with simple questions: What do we observe here? Why might this be the case? What changes if we look at the situation from another perspective? What would happen if we tried a different solution? I try to keep this spirit of inquiry alive in my courses, even when it leads to questions that I cannot answer immediately. For me, these are often honest and valuable moments. They show that learning is not only about arriving at an answer, but also about learning how to think more carefully.

My role as a teacher is therefore not only to stand at the front of the room and transfer knowledge. I provide orientation, structure, and support, but I do not want the classroom to depend only on me. The idea of the teacher as a “guide on the side” is important to me. Students should receive enough guidance to start well, but also enough autonomy to struggle productively, make choices, take ownership, and develop confidence in their own thinking. This balance between structure and autonomy is central to how I design learning experiences.

My teaching style is strongly experiential, problem-oriented, and competence-oriented. I work with case studies, group puzzles, role plays, flipped classroom elements, hands-on workshops, business model tools, simulations, project-based tasks, and challenge-based formats. These methods are especially useful in entrepreneurship, management, organization, and sustainability, because students must learn to deal with ambiguity, incomplete information, competing perspectives, and practical consequences. For me, such methods are not decorative additions to teaching. They are ways of making learning visible, active, and transferable.

At the same time, demanding learning requires a supportive environment. Students should feel able to ask questions, offer ideas, disagree respectfully, and speak from their own perspective without being judged. I value it when students bring in their professional experience, disciplinary background, cultural perspective, or personal way of thinking. Often, these contributions make the classroom more alive and create learning moments that could not have been planned in advance. Structure, trust, dialogue, and experimentation are therefore not separate from good teaching. They are the conditions that make deeper learning possible.

Feedback is another essential part of this learning environment. I use lecturer feedback, peer feedback, presentation feedback, discussions, and structured assessment formats to help students understand the quality of their work and identify the next step. Good feedback should be encouraging, but it should also be specific enough to improve the work. It should help students see not only what is missing, but also what is already emerging.

Ultimately, I want my courses to help students connect knowledge with action. I want students to leave university not only with clearer concepts, but with sharper thinking, stronger confidence, and a greater ability to engage responsibly with complex problems. In a world in which information is abundant, the task of teaching is not simply to add more information. It is to help students transform knowledge into judgement, judgement into action, and action into responsible contribution.
...
Teaching entered my life early and in several very different contexts: first through a short PowerPoint teaching session during my high school year in the United States, then through language teaching with Chinese and Taiwanese students in Vienna, later through fourteen months of English teaching at a university in China, and eventually through teaching in environmental science, ecotoxicology, management, entrepreneurship, and sustainability.

Looking back, these experiences shaped my understanding of teaching in many ways. I learned that good teaching needs preparation, structure, and clarity, but also presence, flexibility, experimentation, and a willingness to respond to the people in the room. My early teaching experiences were often improvised and resource-constrained; later, my academic teaching became more systematic through Moodle-based course organization, assessment rubrics, case studies, problem-based learning, thesis supervision, and higher education didactics.

Today, at Graz University of Technology, I approach teaching as an ongoing design and learning process. My work in industry, consulting, environmental research, and psychosocial counseling has strengthened my interest in helping students connect concepts with action, ask better questions, and gain confidence when dealing with complex and open-ended problems. This path has led me to see higher education as a space where students prepare to engage responsibly with the problems of their time.
...
<p>At 20, I spent fourteen months teaching English communication and listening classes at Qiqihar University and the Hermann Gmeiner Vocational School in China, with a teaching load of 16 hours per week. I also taught middle school students (class sizes of 80 students per classroom) and worked with a private student that I tutored in English and German. For someone still very young and still learning how to teach, this was a demanding but also formative experience. Especially at the beginning, the conditions were quite simple: for the first months, we had no computer and no internet access. This forced me to work experimentally and creatively. I developed much of the teaching material myself, wrote role plays, prepared students for job interviews, worked with scenes from films, built vocabulary exercises around them, and gained my first experience conducting oral exams.</p>

<p>This period was challenging at first. I had to learn how to stand in front of large groups, create structure, vary methods, and keep students engaged. But it was also formative. By the second semester, I had grown into the role and started to experience teaching as a craft that develops through practice, improvisation, observation, and reflection.</p>

<p>In 2008/2009 I was asked to do private language teaching. I studied Japanese at that time, and my Japanese teacher had asked me if I was willing to teach German as a foreign language to the wife of a Japanese diplomat and the wife of a Japanese professor. I accepted and again found myself in a similar format to what had proven successful earlier: I gave them writing assignments, and that again guided me in where to work with them. We did role plays, conversation exercises, grammar exercises and vocabulary building exercises. </p>

<p>From 2014 to 2017, I taught at the University of Applied Sciences Technikum Wien in areas such as aquatic ecotoxicology, environmental management, metrology, applied research projects, selected topics of environmental management, introductory chemistry laboratory work, endocrine disruptors including laboratory work, environmental chemistry, cell culture techniques, and environmental analysis.</p>

<p>This teaching role emerged quite organically from my master’s thesis work. My thesis had been very well received, and the head of the institute wanted me to stay longer so that the method I had developed could be further used and taught to students. I also had ideas about how the study programme could be developed further. He eventually asked me whether I would be willing to teach, as this would allow him to make me a more substantial offer. I accepted, and this became my first longer academic teaching and research position.</p>

<p>During this period, many aspects of my teaching became more professional. I worked with Moodle-based course organization, laboratory entrance tests, assessment rubrics, LaTeX-based exams, problem-based learning, case studies, and thesis supervision. I was also among the first in the programme to work more explicitly with case studies and later actively contributed to the introduction of problem- and challenge-based learning.</p>

<p>One experience that stayed with me was the Applied Research Project. I developed a case study for the course and coached a group of students through their project work. They became highly engaged and eventually won the first prize with their poster. I remember this as a particularly rewarding mentoring experience, because I could see how students grew into the topic, took ownership of their work, and became proud of the result.</p>

<p>I also supervised my first master’s theses during this period. This taught me how important it is to find the right level of feedback: not too directive, not too detailed, but structured enough to help students move forward. I began to understand supervision as a process of orientation, encouragement, and gradual academic independence.</p>

<p>Another important development was assessment. I introduced a grading rubric for laboratory reports based on the IMRAD structure, which created a more transparent basis for evaluating student work and later became useful for other lecturers as well. I also developed a grading rubric for student presentations. In lectures, I worked strongly with visual material and personal stories from laboratory work and research experience, because I wanted students to connect abstract concepts with concrete scientific practice.</p>

<p>Since joining Graz University of Technology, I have approached teaching development more consciously and systematically. After several years in industry, returning to academia felt energizing. I enjoy the intellectual exchange, the work with students, the possibility to teach in a team, and the fact that teaching itself can become an ongoing learning process.</p>

<p>I also notice that I now enter the classroom with more life and work experience than I did in my earlier teaching years. My time in industry, consulting, environmental research, and psychosocial counseling has changed the way I look at learning. I am less interested in students simply reproducing content, and more interested in helping them make connections, apply concepts, ask better questions, and gain confidence when dealing with complex and open-ended problems.</p>

<p>Over time, I have come to the conclusion that it is one of the central tasks of higher education that we prepare students to work on the problems of their time. These problems are rarely solved by memorizing finished answers. They require students to engage with uncertainty, to work with real or realistic challenges, to listen to different perspectives, and to develop their own capacity for judgment and action.</p>

<p>This is one reason why approaches such as Education for Sustainable Development resonate strongly with me. They ask students to think in systems, to collaborate, to reflect on values and consequences, and to develop problem-solving competence in situations where there may be no single correct answer. I find this especially relevant in entrepreneurship, management, and sustainability-related teaching.</p>

<p>For me, this is also connected to a broader responsibility of university teaching. Students will later contribute in companies, public institutions, political contexts, entrepreneurial projects, research environments, or leadership roles. I want my teaching to support them in becoming more capable of engaging with complexity and contributing responsibly wherever they will eventually work.</p>
...
The video presents circular economy as a design challenge that goes beyond recycling and focuss on reducing resource inflows, strengthening internal loops, preserving product and material value, and limiting waste outflows. It also introduces the R-Hierarchy of circularity and connects circular economy to the ecological-economic distinction between an “empty world” and a “full world”.
...
The purpose of the exercise is to make students actively work with the language of entrepreneurial marketing. Instead of only hearing examples, they identify, compare, and classify different activities. This has made the marketing section more interactive and easier to grasp. In addition to that, I show some funny pictures of very creative past guerrilla marketing activities by several well-known companies. This is a great way to end the input session of "the marketing plan".
...
In the Entrepreneurship course, I facilitate a Design Thinking session based on the Stanford d.school “Lunch Experience” materials. Here I want to make a disclaimer: I did not develop this format myself, and I also did not introduce it to the course. This was done by a former colleague and during my very first iteration of the course I participated in this activity together with the other students of the course. I remain committed to teaching it, because I myself experienced a lot of fun doing it and because it allows students to experience a complete innovation process in a short and accessible way.

Students move through the process of understanding user needs, interviewing, ideating, prototyping, testing, and reflecting. This makes Design Thinking more tangible than a purely conceptual explanation. The session is often lively with activating and reflective music playing in the background, a countdown timer running and me in my facilitator role giving instructions and encouraging students. It helps students experience how customer orientation, rapid prototyping, and feedback can support the development of entrepreneurial ideas. I think this activity is a big learning experience for how to approach product innovation that they will not forget so easily.
...
Feedback is a useful development tool. It allows me to capture the "intelligence" of all students and their creative ideas and therefore has the potential to bring ideas I might have never had. In the past, I have worked with oral feedback, institutional evaluation forms, written feedback, and informal student reflections. In the Entrepreneurship course, we actively ask students what their highlights were and what they would like to see more of. We do this orally, we ask questions to the group, and they respond, and we capture the feedback and ideas on paper and then see where we can make changes.

For myself, I try to translate feedback into concrete improvements. When feedback points to possible changes, I document it directly in my teaching materials (by adding a post-it note on the respective print-out) so that I have it ready when preparing the next course iteration.

Critical feedback is not always easy to handle for me, especially when I put a lot of effort into a course. This is an area that I am currently developing. I want to become better at distinguishing between individual opinions and recurring patterns, and at translating useful criticism into concrete improvements without taking every critical comment personally. For me, this is part of developing a more professional feedback culture: feedback should not only confirm what works, but also help identify where learning activities, instructions, materials, or assessment criteria can become clearer.
...
The common pattern that is visible across the above-mentioned examples: I try to move students from listening to concepts towards working with them. Of course students still need an introduction first so that they grasp methods and frameworks through examples. But I try to combine these inputs with activities that require students to apply, compare, visualize, discuss, evaluate, or create something new.
...
When I first started teaching, I could not fully grasp teaching competence as a broad professional competence yet. In China, much of my teaching developed through experimentation. I had limited resources available, but I was young, confident, and willing to try things out. One of my first insights was that teaching becomes more meaningful when students are asked to actively work with knowledge.

An early example that resulted from this period was the discussion format on world affairs. Instead of asking students to give traditional presentations on freely chosen topics, as other lecturers had done in the past, I asked them to prepare a short opening statement on a current topic in world politics or current news and then moderate a discussion with their classmates. Together with my mother, who was an English teacher, I also developed my very first grading rubric for this format. Looking back, this was one of my first experiences of designing an assessment format around the actual communicative competence I wanted students to develop: leading a discussion, responding to others, moderating interaction, and reflecting afterwards.

At UAS Technikum Wien, I learned from colleagues, observed what I identified as good practice, and gradually developed my own approaches to laboratory teaching. I also made my first experiences with Moodle-based course organization, exam assessment, and developing teaching materials. Laboratory entrance tests and a structured rubric for laboratory reports helped me understand assessment not only as grading, but also as a way to clarify expectations, guide preparation, and support learning.
...
This understanding resonates with teaching competence models that describe professional teaching as a combination of values and attitudes, methodological and didactic abilities, contextual knowledge, and social and self-competence. The Teaching Competence Model for the Styrian Higher Education Area is helpful for me in this regard because it makes visible that professional teaching is not just a matter of methods. It also includes appreciation, empathy, diversity awareness, planning, assessment, communication, and self-reflection.

I recognize myself especially in the areas of appreciation and empathy, student-centeredness, diversity awareness, and the willingness to reflect on my own teaching. At the same time, the model also helps me identify areas for further development. For example, I would like to become more systematic in planning learning sequences, defining learning outcomes for individual sessions, and preparing materials that allow students to work more independently and actively. I also want to continue developing a more professional feedback culture by identifying patterns, distinguishing individual opinions from broader issues, and translating useful criticism into concrete improvements.

I also find the pragmatic model of teaching competence by Fleischmann, Jäger, and Strasser useful for my own reflection. It distinguishes between developing teaching concepts, implementing them, organizing teaching, and reflecting on and further developing teaching. This fits with my own development well. I understand teaching as a professional practice that includes the design of learning environments, the facilitation of classroom interaction, the organization of materials and learning processes, the transparent assessment of student outputs, and the continuous improvement of courses based on observation and feedback.

An important realization that I had in my current teaching is that structure creates a calm atmosphere. Structure does not mean controlling every moment of a session. It creates orientation and security, both for students and for myself. A clear structure makes it easier to open spaces for discussion, experimentation, group work, and student contributions.

This is why my focus has shifted more towards creating learning experiences. A good learning experience for me is a situation in which students do something with content. This could be moderating a discussion, classifying leadership behavior, drawing an organizational structure, developing a persona or organizata, estimating a market, prototyping an idea, giving feedback from a stakeholder perspective, or challenging a business model. These activities create moments that remain more memorable than pure explanation, because students connect concepts with action, interaction, and their own thinking.

Concerning my teaching style, I can say that it is an ongoing process. Slides still remain an important support structure for me, especially for orientation and timing. I also find that they give the class structure. However, I would like to move further toward more "open" teaching sequences, more work with blackboards, whiteboards, flipcharts and more movement in the room. I want to become less dependent on the lectern and the screen, and more able to generate structures together with students in the moment.

The Teaching Academy has strongly influenced this development. Some elements were already present in my teaching in an intuitive form. Through the Teaching Academy, I have gained language, frameworks, and concrete methods to develop them more consciously.

Looking ahead, I want to continue developing my teaching in three interconnected directions: more structured but flexible learning sequences, more systematic use of student feedback, and a stronger integration of Education for Sustainable Development into entrepreneurship, management, and sustainability education.

I also want to strengthen the connection between research and teaching wherever this is possible. For me, teaching becomes particularly alive when I can bring in questions, cases, uncertainties, or insights from my own research and professional work.

For me, developing teaching competence means moving from experience and intuition toward an evidence-informed and professionally grounded teaching practice, without losing the openness, presence, curiosity and responsiveness that make teaching alive.
