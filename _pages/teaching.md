...
The quote by Confucius contains the character 習 (xí) which can mean practice, review, repeated exercise, and gradually becoming familiar with something. Something is learned, revisited, tried again, and slowly becomes part of how a person sees and acts. Another character in the quote is 說 (yuè), used here in the sense of 悅 (yuè), meaning joy, delight, or inner satisfaction. It attests to the satisfaction that can arise when something has been practiced, understood more deeply, and slowly made one’s own.

Aristotle states something very similar from within another philosophical world. In the phrase ποιοῦντες μανθάνομεν (poioûntes manthánomen), “by doing, we learn,” learning is connected to action. Our capability grows when we try, repeat, correct ourselves, receive feedback, and slowly become more competent.

In the framework below, I take these two persepctives as the philosophical basis of my teaching philosophy. Kant adds another layer to it with "Sapere aude" (have the courage to use your own understanding). This, to me, speaks about intellectual maturity: the courage to think for oneself, to question what is handed down, to examine what others say, and to take responsibility for one’s own judgement. In a time of online sources, generative AI, expert opinions, social media, and ready-made explanations, this matters even more. Students should learn to use books, teachers, digital tools, and AI intelligently.

Finally Seneca’s phrase "Non scholae, sed vitae discimus" (we learn for life, not for school), points toward why we learn at all. Strictly speaking, of course, the phrase is a later reversal of Seneca’s own criticism that education can become too detached from life.  This quote also makes me think back to the early days of universities: In the medieval university, the lecture had a very clear function. A learned person read, explained, interpreted, and transmitted texts that students could usually not access so easily by themselves. In that situation, the lecture was a gateway to knowledge.
...
But what happens after students have found information? Can they make sense of it? Can they question it? Can they compare it with other perspectives? Can they use it in a situation where the answer is not already clear? This is where I still see the university as a deeply meaningful place. At its best, it is a place where students train their minds, grow as persons, test ideas, receive feedback, and learn to work with problems that matter.
...
This is the point of departure for my teaching philosophy: I understand teaching as the **design of learning spaces**. Such spaces need structure, but they also need openness. In terms of **strcuture**, students need clear concepts, useful frameworks, good examples, and tasks that make sense. In terms of **openness** they need room to ask questions, try things out, make mistakes, compare perspectives, receive feedback, and think again about what they have learned. Good teaching, in this sense, is about creating situations in which knowledge can become something students can actually use.
